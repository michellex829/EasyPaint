...
class RectangleStrategy extends AbstractShapeClass {
    ...
    public RectangleStrategy(ShapeGenerator shapeGenerator) {
    ...
    public void drawSelectedOutline() {
        ...
        graphics2d.drawRect(startPoint.getX() - 9, startPoint.getY() - 9, width + 18, height + 18);
    }

    public ShapeGenerator getShapeGenerator() { return shapeGenerator; }

    public void setStartPoint(Point startPoint) { this.startPoint = shapeGenerator.getStartPoint(); }

    public void setEndPoint(Point endPoint){ this.endPoint = shapeGenerator.getEndPoint(); }
